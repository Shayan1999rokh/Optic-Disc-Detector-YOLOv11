...
The pretrained weights are automatically downloaded from the official Ultralytics Website if they do not already exist.
...
@software{optic_disk_yolo11,
  title={Optic Disk Detector using YOLOv11},
  author={Your Name},
  year={2026}
}

---
# Read me is generated using GPT. Check the important info
